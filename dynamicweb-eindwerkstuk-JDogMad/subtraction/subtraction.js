...
let score = 0;
let highscore = localStorage.getItem('highscore_sub');
let plays = 10;
...
function generateEquation() {
    ...
    if (localStorage.getItem('continue_sub') === 'true') {
...
function keepPlays() {
    ...
    if (plays == 0) {
        ...
        localStorage.setItem('score_sub', score);
        ...
        localStorage.setItem('highscore_sub', highscore);
        ...
        document.getElementById('continue').addEventListener('click', function () {
            localStorage.setItem('continue_sub', true);
        });
